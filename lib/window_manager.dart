...
class WindowController {
  static const _channel = MethodChannel('window_controller');
  ...
  static Future<bool?> showWindow(String key) {
    try {
      return _channel.invokeMethod<bool>('showWindow', {"key": key});
    } catch (e) {
      return Future.value(false);
    }
  }

  static Future<bool?> hideWindow(String key) {
    try {
      return _channel.invokeMethod<bool>('hideWindow', {"key": key});
    } catch (e) {
      return Future.value(false);
    }
  }
